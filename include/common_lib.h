...
#define DEBUG 1
#define GEOMETRY_TOLERANCE 0.30
...
struct Params {
  ...
  double lidar_template_max_inside_support_ratio;
  double lidar_template_min_support_per_hole;
...
Params loadParameters(ros::NodeHandle &nh) {
  ...
  nh.param("lidar_geometry_side_rel_tol", params.lidar_geometry_side_rel_tol, 0.15);
  nh.param("lidar_geometry_diag_rel_tol", params.lidar_geometry_diag_rel_tol, 0.15);
  nh.param("lidar_geometry_perimeter_rel_tol", params.lidar_geometry_perimeter_rel_tol, 0.15);
  nh.param("lidar_min_plane_points", params.lidar_min_plane_points, 700);
  nh.param("lidar_ransac_min_inliers", params.lidar_ransac_min_inliers, 12);
  nh.param("lidar_ransac_radius_tolerance", params.lidar_ransac_radius_tolerance, 0.02);
  nh.param("lidar_ransac_inlier_threshold", params.lidar_ransac_inlier_threshold, 0.010);
  ...
  nh.param("lidar_template_max_inside_per_hole", params.lidar_template_max_inside_per_hole, 6);
  nh.param("lidar_template_max_inside_support_ratio", params.lidar_template_max_inside_support_ratio, 0.35);
  nh.param("lidar_template_min_support_per_hole", params.lidar_template_min_support_per_hole, 3.0);
